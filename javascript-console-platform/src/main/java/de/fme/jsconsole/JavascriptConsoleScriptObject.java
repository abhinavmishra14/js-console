...
public class JavascriptConsoleScriptObject {
	...
	/**
	 * Alternative constructor that allows clients to provide a specific data
	 * structure for print output management.
	 * 
	 * @param printOutput the list structure in which to accumulate print output via
	 *                    the {@code print} extension
	 */
	...
	private String formatChildAssoc(ChildAssociationRef value) {
		return "ChildAssociationRef: parent=" + value.getParentRef().toString() + ", child="
				+ value.getChildRef().toString();
	}
