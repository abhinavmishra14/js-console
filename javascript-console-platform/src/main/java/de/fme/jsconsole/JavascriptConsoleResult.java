...
/**
 * Stores the result of a script and template execution on the Javascript
...
public class JavascriptConsoleResult extends JavascriptConsoleResultBase {
	...
	/** The dump output. */
	private final List<JsConsoleDump> dumpOutput = new ArrayList<>();
	...
	/**
	 * Generates the execution summary / details of the handled JavaScript Console
	 * request.
	 *
	 * @return the JSON object structure of the execution summary / details
	 * @throws JSONException if an error occurs preparing the execution summary /
